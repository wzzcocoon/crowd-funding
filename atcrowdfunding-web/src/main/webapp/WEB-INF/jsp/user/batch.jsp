        ...
        <script type="text/javascript">
            $(function () {
			    ...
			    $("#addBtn").click(function(){
			    	var content = "";
			    	content += '<tr>';
             		content += '	<td><input type="text" class="form-control" name="users['+ userCount +'].loginacct"/></td>';
             		content += '	<td><input type="text" class="form-control" name="users['+ userCount +'].username"/></td>';
             		content += '	<td><input type="text" class="form-control" name="users['+ userCount +'].eamil"/></td>';
